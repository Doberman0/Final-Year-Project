...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    public class PinchSlider : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusHandler
    {
        ...
        // Are we manipulating the longitude or latitude?
        public bool long_or_lat;
        ...
        public float SliderValue
        {
            ...
            set
            {
                ...
                int new_rot = (int)(SliderValue * 360); // New rotation;

                if (long_or_lat) // We are manipulating longitude
                {
                ...
                else // We're manipulating latitude of the armillary sphere
                {
                    //I added this to rotate the cube
                    armillary_sphere.transform.localEulerAngles = new Vector3(
                        armillary_sphere.transform.localEulerAngles.x,
                        armillary_sphere.transform.localEulerAngles.y,
                        new_rot);
                }
                ...
                value_UI.GetComponent<TextMesh>().text = new_rot.ToString() + "°";
            }
        }
